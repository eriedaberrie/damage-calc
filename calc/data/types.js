...
var XY = (0, util_1.extend)(true, {}, GSC, {
    '???': { Fairy: 1 },
    Normal: { Fairy: 1, Nuclear: 2 },
    Grass: { Fairy: 1, Nuclear: 2 },
    Fire: { Fairy: 1, Nuclear: 2 },
    Water: { Fairy: 1, Nuclear: 2 },
    Electric: { Fairy: 1, Nuclear: 2 },
    Ice: { Fairy: 1, Nuclear: 2 },
    Flying: { Fairy: 1, Nuclear: 2 },
    Bug: { Fairy: 0.5, Nuclear: 2 },
    Poison: { Fairy: 2, Nuclear: 2 },
    Ground: { Fairy: 1, Nuclear: 2 },
    Rock: { Fairy: 1, Nuclear: 2 },
    Fighting: { Fairy: 0.5, Nuclear: 2 },
    Psychic: { Fairy: 1, Nuclear: 2 },
    Ghost: { Steel: 1, Fairy: 1, Nuclear: 2 },
    Dragon: { Fairy: 0, Nuclear: 2 },
    Dark: { Steel: 1, Fairy: 0.5, Nuclear: 2 },
    Steel: { Fairy: 2, Nuclear: 2 },
    Fairy: {
        '???': 1,
        Normal: 1,
        Grass: 1,
